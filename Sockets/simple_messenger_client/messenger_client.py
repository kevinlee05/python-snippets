...
class Sender(threading.Thread):
    def __init__(self, server_host, server_port, user_name, local_host, local_port):
        ...
        # on initialization, the Sender will send a message to the server for it to acknowledge the new user.
...
def main():
    ...
    #The sender now receives both the endpoint from the remote server and the local one on initialization
