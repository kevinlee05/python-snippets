...
class WSGIServer(object):
    ...
    def handle_one_request(self):
        ...
        # It's time to call our application callable and get back a result thta will become HTTP response body
    ...
    def start_response(self, status, response_headers, exc_info=None):
        ...
        server_headers = [
            ('Date', 'Sun, 18 Mar 2018 00:40:40 GMT+8'),
            ('Server', 'WSGIServer 0.2'),
        ]
        self.headers_set = [status, response_headers + server_headers]
        #To adhere to WSGI specification the start_response must return a 'write' callable. For simplicity's sake we'll ignroe that detail for now
